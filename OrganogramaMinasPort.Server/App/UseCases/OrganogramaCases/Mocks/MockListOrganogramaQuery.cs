...
namespace OrganogramaMinasPort.Server.App.UseCases.OrganogramaCases.Mocks
{
    public class MockListOrganogramaQuery : IListOrganogramaQuery
    {
        public async Task<List<OrganogramaResponse>> Execute(string tipo)
        {
            ...
            if (tipo == "pessoal")
                organogramas = OrganogramaPessoal();

            return await Task.FromResult(organogramas);
        }

        private List<OrganogramaResponse> OrganogramaPessoal()
        {
            List<Employee> employees = new List<Employee>
            {
                ...
                new Employee
                {
                    Id = 2,
                    Name = "Tiago Costa",
                    PositionName = "Diretor de Operações",
                    Phone = "99887767",
                ...
                new Employee
                {
                    Id = 3,
                    Name = "Kate Oliveira",
                    PositionName = "Diretora de Tecnologia",
                    Phone = "99887768",
            ...
            List<Hierarchy> hierarchies = new List<Hierarchy>
            {
                ...
                new Hierarchy{ Id = 4, EmployeeId = 4, ParentId = "3" },
                new Hierarchy{ Id = 5, EmployeeId = 5, ParentId = "3" },
                new Hierarchy { Id = 7, EmployeeId = 7, ParentId = "8" },
                new Hierarchy { Id = 8, EmployeeId = 8, ParentId = "1" },
                new Hierarchy { Id = 10, EmployeeId = 10, ParentId = "5" },
                new Hierarchy { Id = 11, EmployeeId = 11, ParentId = "5" },
                new Hierarchy { Id = 13, EmployeeId = 13, ParentId = "2" },
                new Hierarchy { Id = 14, EmployeeId = 14, ParentId = "13" },
                new Hierarchy { Id = 16, EmployeeId = 16, ParentId = "1" },
                new Hierarchy { Id = 17, EmployeeId = 17, ParentId = "16" },
                new Hierarchy { Id = 19, EmployeeId = 19, ParentId = "4" },
                new Hierarchy { Id = 20, EmployeeId = 20, ParentId = "4" },
                new Hierarchy { Id = 21, EmployeeId = 21, ParentId = "4" },
                new Hierarchy { Id = 22, EmployeeId = 22, ParentId = "4" },
                new Hierarchy { Id = 23, EmployeeId = 23, ParentId = "4" },
                new Hierarchy { Id = 24, EmployeeId = 24, ParentId = "4" },
                new Hierarchy { Id = 25, EmployeeId = 25, ParentId = "4" },
                new Hierarchy { Id = 26, EmployeeId = 26, ParentId = "4" },
                new Hierarchy { Id = 27, EmployeeId = 27, ParentId = "4" },
                new Hierarchy { Id = 28, EmployeeId = 28, ParentId = "4" },
                new Hierarchy { Id = 29, EmployeeId = 29, ParentId = "4" },
                new Hierarchy { Id = 30, EmployeeId = 30, ParentId = "4" },
            };     

            List<OrganogramaResponse> organogramas = CreateOrganogramaResponse(employees, new List<Team>(), hierarchies);
            return organogramas;
        }
